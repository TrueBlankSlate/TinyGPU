...
module tb;
    ...
    design_1_wrapper dut(
        .clk_0(clk), .rst_0(rst), .we_0(we),
        .instruction_0(instruction),
        .vs1_in_0(vs1_in), .vs2_in_0(vs2_in),
        .vd_0(vd)
    );
    ...
    initial begin
        $monitor("t=%0t | instr=%b | vs1=%0d vs2=%0d | vd=%0d",
                  $time, instruction, vs1_in, vs2_in, vd);
    end
