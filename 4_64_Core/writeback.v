...
//
// Row-major, element k at bit [64k +: 64] -- the SAME layout cache_l3.v
// uses for its own 1024-bit mat_mem lines (see the vmacc row extraction
// there, mat_mem[vs1][pass*256 +: 256]). A written-back result therefore
// sits in memory in exactly the shape a future vle64.v could read straight
// back in, with no re-packing needed on either side.
module writeback(
