...
// C_mul, RESULT_ADDR for C_add) -- matches 4_64_Core/fw/boot_matmul.S's
...
module tb_boot_image;
  ...
  // Absolute path -- $readmemh resolves this at elaboration time against
  // xsim's working directory, and a relative path's behavior depends on
